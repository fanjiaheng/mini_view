...
CCameraSetting::CCameraSetting(QWidget *parent): QWidget(parent), ui(new Ui::CameraSetting)
{
    ui->setupUi(this);
...
void CCameraSetting::init()
{

}

void CCameraSetting::pre()
{
    ui->tableWidget ->setFocus();
}

void CCameraSetting::keyPressEvent(QKeyEvent *ev)
{
